...
export const IconChipContainer = styled.div`
  display: flex;
  margin: 35px 0;
`;
...
export const IconChipText = styled.span`
  font-weight: bold;
  font-size: 16px;
  line-height: 19px;
  color: ${(props) => props.theme.gray[500]};
...
export const WhoWeAre = () => (
  <SectionContainer>
    <SectionHeader
      headerText="kim jesteśmy"
      subheaderText="Poznaj nas lepiej"
    ></SectionHeader>
    <div className="grid md:grid-rows-1 md:grid-cols-3">
      ...
      <div className="col-span-2 auto-rows-auto mt-12 md:ml-20 md:mt-0">
        <DescriptionHeader>
          Jesteśmy <Highlight>appsme</Highlight>, czyli...
        </DescriptionHeader>
        <Paragraph>
          ...
          technologiczne. Uważamy, że ciągły rozwój i pasja w tym co się robi to
          jedyna słuszna droga żeby być najlepszym i poprzez pracę wnosić
          wartość do biznesu naszych klientów.
        </Paragraph>
        <IconChipContainer>
          <IconChip>
            <HeartIcon />
